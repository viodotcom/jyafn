...
class Ref:
    ...
    def __add__(self, other: Ref) -> Ref: ...
    def __radd__(self, other: Ref) -> Ref: ...
    def __sub__(self, other: Ref) -> Ref: ...
    def __rsub__(self, other: Ref) -> Ref: ...
    def __mul__(self, other: Ref) -> Ref: ...
    def __rmul__(self, other: Ref) -> Ref: ...
    def __truediv__(self, other: Ref) -> Ref: ...
    def __rtruediv__(self, other: Ref) -> Ref: ...
    def __floordiv__(self, other: Ref) -> Ref: ...
    def __rfloordiv__(self, other: Ref) -> Ref: ...
    def __mod__(self, other: Ref) -> Ref: ...
    def __rmod__(self, other: Ref) -> Ref: ...
    def __pow__(self, other: Ref) -> Ref: ...
    def __rpow__(self, other: Ref) -> Ref: ...
    def __neg__(self, other: Ref) -> Ref: ...
    def __pos__(self, other: Ref) -> Ref: ...
    def __abs__(self, other: Ref) -> Ref: ...
    ...
    def __rand__(self, other: Ref) -> Ref: ...
    def __or__(self, other: Ref) -> Ref: ...
    def __ror__(self, other: Ref) -> Ref: ...
    def choose(self, if_true: Ref, if_false: Ref) -> Ref:
        """
...
def pow(base: Ref, exponent: Ref) -> Ref: ...
def floor(x: Ref) -> Ref: ...
def ceil(x: Ref) -> Ref: ...
def round(x: Ref) -> Ref: ...
def trunc(x: Ref) -> Ref: ...
...
def atanh(x: Ref) -> Ref: ...
def gamma(x: Ref) -> Ref: ...
def loggamma(x: Ref) -> Ref: ...
def factorial(x: Ref) -> Ref: ...
def rgamma(x: Ref) -> Ref: ...
def digamma(x: Ref) -> Ref: ...
def erf(x: Ref) -> Ref: ...
def erfc(x: Ref) -> Ref: ...
def norm(x: Ref) -> Ref: ...
def norm_inv(x: Ref) -> Ref: ...
def riemann_zeta(x: Ref) -> Ref: ...
def is_nan(x: Ref) -> Ref: ...
def is_finite(x: Ref) -> Ref: ...
def is_infinite(x: Ref) -> Ref: ...
def powf(base: Ref, exponent: Ref) -> Ref: ...
def rem(x: Ref, mod: Ref) -> Ref: ...
def beta(x: Ref, y: Ref) -> Ref: ...
def logbeta(x: Ref, y: Ref) -> Ref: ...
def gammainc(x: Ref, y: Ref) -> Ref: ...
def gammac(x: Ref, y: Ref) -> Ref: ...
def gammac_inv(x: Ref, y: Ref) -> Ref: ...
def besselj(x: Ref, y: Ref) -> Ref: ...
def bessely(x: Ref, y: Ref) -> Ref: ...
def besseli(x: Ref, y: Ref) -> Ref: ...
def timestamp(x: Ref) -> Ref: ...
def fromtimestamp(x: Ref) -> Ref:
    """
    Creates a datetime ref from this scalar ref containing an Unix timestamp in seconds.
    """
